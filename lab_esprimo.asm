.data
    ...
    mensaje4: .asciiz "Debe ingresar un munero mayor a 1. "
.text
    .globl main
    main:
        ...
        slti $t3,$a0,2	# numero < 2 : los numeros primos son  N>2
        beq $t3,1,MENOR # si el numero es menor a 2, salimo sy mandamos un mansaje or consola
	...
	li $t1,1	# $t1 la usaremos para comparar con el resultado
        ...
        li $v0, 4
        la $a0, mensaje3 # el numero es menor a 2
        syscall
        j fin
